	...
	<?php foreach($use_form as $form_item) : ?>
        <li>
            <?php if(isset($form_item["main_section"])) : ?>
                <label class="parent-label"><?php _e($form_item["main_section"]);?></label>
                <div class="form-wrap">                 	
            ...
            <?php else : ?>
                <label class="parent-label"><?php _e($form_item["label"]);?></label>
                <div class="form-wrap">
                    ...
                    <?php if(isset($form_item["description"]) && $form_item["description"] !== "") : ?>
                        <span class="tooltip"><?php _e($form_item["description"]);?></span>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </li>
