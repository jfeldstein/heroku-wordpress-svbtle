			...
			<div class="section">
	            ...
	            <div class="instructions">
	                ...
	                <ul class="instruction-list">
	                    <li class="column"><a href="<?php echo admin_url('widgets.php'); ?>" target="blank">Setup Widgets</a></li>
                        ...
                        <li class="column"><a href="<?php echo admin_url('nav-menus.php'); ?>"  target="blank">Setup Your Menus</a></li>
	                </ul>
	            </div> 
